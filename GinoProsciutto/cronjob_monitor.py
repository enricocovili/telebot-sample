...
import asyncio, subprocess, re, logging


async def journal_log(bot: TelegramClient):
    ...
    if float(temp) >= Utils.TEMPERATURE_WARNING_LIMIT:
        ...
        for line in top_output:
            ...
            line = "{col0:<5}, {col1:<5}, {col8:<5}, {col9:<5}, {col11:>5}".format(
                col0=line[0], col1=line[1], col8=line[8], col9=line[9], col11=line[11]
            )
